    ...
    >
      ...
      <div className="p-6 pt-8 relative flex-1 flex flex-col">
        <div className="flex justify-between items-start mb-4">
          <div className="w-16 h-24 bg-gradient-to-br from-gray-700 to-gray-900 rounded-lg shadow-lg flex items-center justify-center text-white/20 border border-white/10 shrink-0">
             <Book size={32} />
          </div>
        ...
        <div className="mt-auto flex items-center justify-between pt-4 border-t border-white/5">
          <div className="flex items-center gap-2 text-emerald-400/80 text-xs">
             <Globe size={12} />
             <span>已索引源: {novel.sourceUrls?.length || 0}</span>
          </div>
